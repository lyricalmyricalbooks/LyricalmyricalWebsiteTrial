...
export function Checkout() {
  ...
  const validateDiscountRestrictions = (discount: any, email: string, cartItems: any[], catalogMap: Map<string, any>, itemsCount: number, itemsSubtotal: number) => {
    // 1. Min quantity / min order amount
    if (discount.minQuantity && itemsCount < discount.minQuantity) {
