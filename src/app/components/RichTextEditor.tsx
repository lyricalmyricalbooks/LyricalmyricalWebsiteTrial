    ...
    >
      ...
      >
        ...
        <span className="ql-formats !mr-3">
          <select aria-label="Format header" className="ql-header bg-transparent border border-neutral-200 dark:border-neutral-800 text-[10px] font-black tracking-widest uppercase outline-none cursor-pointer rounded-lg px-2 py-1.5 hover:bg-neutral-200 dark:hover:bg-neutral-800 transition-colors">
        ...
        <span className="ql-formats !mr-3 flex items-center gap-1 border-r border-neutral-200 dark:border-neutral-800 pr-3">
          <button aria-label="Bold text" className="ql-bold p-1.5 text-neutral-600 dark:text-neutral-300 hover:bg-neutral-200 dark:hover:bg-neutral-800 rounded-lg transition-all flex items-center justify-center">
            <Bold size={14} />
          </button>
          <button aria-label="Italic text" className="ql-italic p-1.5 text-neutral-600 dark:text-neutral-300 hover:bg-neutral-200 dark:hover:bg-neutral-800 rounded-lg transition-all flex items-center justify-center">
            <Italic size={14} />
          </button>
          <button aria-label="Underline text" className="ql-underline p-1.5 text-neutral-600 dark:text-neutral-300 hover:bg-neutral-200 dark:hover:bg-neutral-800 rounded-lg transition-all flex items-center justify-center">
            <Underline size={14} />
          </button>
          <button aria-label="Strikethrough text" className="ql-strike p-1.5 text-neutral-600 dark:text-neutral-300 hover:bg-neutral-200 dark:hover:bg-neutral-800 rounded-lg transition-all flex items-center justify-center">
        ...
        {/* Colors */}
        <span className="ql-formats !mr-3 flex items-center gap-1 border-r border-neutral-200 dark:border-neutral-800 pr-3">
          <select aria-label="Text Color" className="ql-color" title="Text Color" />
          <select aria-label="Highlight Color" className="ql-background" title="Highlight Color" />
        </span>

        {/* Alignments */}
        <span className="ql-formats !mr-3 flex items-center gap-1 border-r border-neutral-200 dark:border-neutral-800 pr-3">
          <button aria-label="Align text left" className="ql-align p-1.5 text-neutral-600 dark:text-neutral-300 hover:bg-neutral-200 dark:hover:bg-neutral-800 rounded-lg transition-all flex items-center justify-center" value="">
            <AlignLeft size={14} />
          </button>
          <button aria-label="Align text center" className="ql-align p-1.5 text-neutral-600 dark:text-neutral-300 hover:bg-neutral-200 dark:hover:bg-neutral-800 rounded-lg transition-all flex items-center justify-center" value="center">
            <AlignCenter size={14} />
          </button>
          <button aria-label="Align text right" className="ql-align p-1.5 text-neutral-600 dark:text-neutral-300 hover:bg-neutral-200 dark:hover:bg-neutral-800 rounded-lg transition-all flex items-center justify-center" value="right">
            <AlignRight size={14} />
          </button>
          <button aria-label="Justify text" className="ql-align p-1.5 text-neutral-600 dark:text-neutral-300 hover:bg-neutral-200 dark:hover:bg-neutral-800 rounded-lg transition-all flex items-center justify-center" value="justify">
        ...
        {/* Lists */}
        <span className="ql-formats !mr-3 flex items-center gap-1 border-r border-neutral-200 dark:border-neutral-800 pr-3">
          <button aria-label="Numbered list" className="ql-list p-1.5 text-neutral-600 dark:text-neutral-300 hover:bg-neutral-200 dark:hover:bg-neutral-800 rounded-lg transition-all flex items-center justify-center" value="ordered">
            <ListOrdered size={14} />
          </button>
        ...
        {/* Links & Embeds */}
        <span className="ql-formats !mr-3 flex items-center gap-1 border-r border-neutral-200 dark:border-neutral-800 pr-3">
          <button aria-label="Insert link" className="ql-link p-1.5 text-neutral-600 dark:text-neutral-300 hover:bg-neutral-200 dark:hover:bg-neutral-800 rounded-lg transition-all flex items-center justify-center">
            <Link2 size={14} />
          </button>
          <button aria-label="Insert image" className="ql-image p-1.5 text-neutral-600 dark:text-neutral-300 hover:bg-neutral-200 dark:hover:bg-neutral-800 rounded-lg transition-all flex items-center justify-center">
            <ImageIcon size={14} />
          </button>
          <button aria-label="Insert video" className="ql-video p-1.5 text-neutral-600 dark:text-neutral-300 hover:bg-neutral-200 dark:hover:bg-neutral-800 rounded-lg transition-all flex items-center justify-center">
            <Video size={14} />
          </button>
        </span>
