    ...
    >
      ...
      >
        ...
        <span className="ql-formats !mr-3">
          <select aria-label="Select heading level" className="ql-header bg-transparent border border-neutral-200 dark:border-neutral-800 text-[10px] font-black tracking-widest uppercase outline-none cursor-pointer rounded-lg px-2 py-1.5 hover:bg-neutral-200 dark:hover:bg-neutral-800 transition-colors">
